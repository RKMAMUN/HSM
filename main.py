...
def origianl_root():
	...
	def hotel_status():
		...
		path = "images/newbackground1.jpg"
	...
	# ------------inner frames of bottom frame-------------------------
		...
		available_rooms = Label(smf2, text='Rooms Available:', fg='white', bg='cyan4', width=130, height=2, font='helvetica 15')
		available_rooms.pack(side='top')
	...
	def staff():
		...
		emp1.pack()
		emp1f.place(x=0,y=0)
		employee_info = Frame(b_frame,bg='White',height=122,width=300)
		Label(employee_info,text="Manager",bg='white',font='msserif 18 bold').place(x=60,y=0)
		Label(employee_info,text="Mr. Walter Gomez",bg='white',fg="Grey", font=('Helvetica', 10)).place(x=60,y=37)
		Label(employee_info,text="Extention : 020",bg='white',fg="Grey", font=('msserif', 11)).place(x=60,y=59)
		Label(employee_info,text="Mail : walter@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=60,y=83)
		employee_info.pack_propagate(False)
		employee_info.place(x=117,y=1)
		...
		employee_info = Frame(b_frame,bg='White',height=116,width=310)
		Label(employee_info,text="Customer Executive",bg='white',font='msserif 16 bold').place(x=45,y=0)#pack(side='top')
		Label(employee_info,text="Ms. Cindy Camilly",bg='white',fg="Grey",font='msserif 10').place(x=45,y=37)
		Label(employee_info,text="Extention : 030",bg='white',fg="Grey",font='msserif 10').place(x=45,y=59)
		Label(employee_info,text="Mail : cindy@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=45,y=83)
		employee_info.pack_propagate(False)
		employee_info.place(x=767,y=2)
		...
		employee_info = Frame(b_frame,bg='White',height=121,width=320)
		Label(employee_info,text="Restaurant",bg='white',font='msserif 17 bold').place(x=72,y=0)#pack(side='top')
		Label(employee_info,text="Mr. Kim Jung",bg='white',fg="Grey",font='msserif 10').place(x=72,y=37)
		Label(employee_info,text="Extention : 048",bg='white',fg="Grey",font='msserif 10').place(x=72,y=59)
		Label(employee_info,text="Mail : kim@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=72,y=83)
		employee_info.pack_propagate(False)
		employee_info.place(x=99,y=153)
		employee_info.tkraise()
		...
		employee_info = Frame(b_frame,bg='White',height=124,width=315)
		Label(employee_info,text="Room Service",bg='white',font='msserif 17 bold').place(x=55,y=0)#pack(side='top')
		Label(employee_info,text="Ms. Juan cordovus",bg='white',fg="Grey",font='msserif 10').place(x=55,y=37)
		Label(employee_info,text="Extention : 040",bg='white',fg="Grey",font='msserif 10').place(x=55,y=59)
		Label(employee_info,text="Mail : juan@gmail.com",bg='white',fg="Grey",font='msserif 10').place(x=55,y=83)
		employee_info.pack_propagate(False)
		employee_info.place(x=763,y=153)
	...
	def rooms():
		...
		def roomdet(rno):
			...
			total_rooms = Label(smf1,text='Beds (Total):',fg='white',bg='cyan4',width=100,height=2,font=('Helvetica', 15))
			total_rooms.pack(side='top')
			smf1.pack_propagate(False)
			smf1.place(x=129+3,y=30)
			Label(smf1,text=str(rawdata[0][1]),fg='cyan4',bg='white',font='msserif 36').pack()
			smf2 = Frame(b_frame,height=120,width=145,bg='white')
			total_rooms = Label(smf2,text='AC Available?',fg='white',bg='cyan4',width=100,height=2,font='msserif 16')
			total_rooms.pack(side='top')
			smf2.pack_propagate(False)
			smf2.place(x=140*2+5+3*2,y=30)
			Label(smf2,text=str(rawdata[0][2]),fg='cyan4',bg='white',font='msserif 35').pack()
			smf2 = Frame(b_frame,height=120,width=145,bg='white')
			total_rooms = Label(smf2,text='TV Available?',fg='white',bg='cyan4',width=100,height=2,font='msserif 15')
			total_rooms.pack(side='top')
			smf2.pack_propagate(False)
			smf2.place(x=140*3+12+5*2+3*3,y=30)
			Label(smf2,text=str(rawdata[0][3]),fg='cyan4',bg='white',font=('Helvetica', 35)).pack()
			smf2 = Frame(b_frame,height=120,width=145,bg='white')
			total_rooms = Label(smf2,text='  Wifi ?',fg='white',bg='cyan4',width=100,height=2,font='msserif 15')
			total_rooms.pack(side='top')
			smf2.pack_propagate(False)
			smf2.place(x=140*4+12*2+5*3+3*4,y=30)
			Label(smf2,text=str(rawdata[0][4]),fg='cyan4',bg='white',font='msserif 35').pack()
			smf2 = Frame(b_frame,height=120,width=145,bg='white')
			total_rooms = Label(smf2,text=' Price ?',fg='white',bg='cyan4',width=100,height=2,font='msserif 15')
			total_rooms.pack(side='top')
			smf2.pack_propagate(False)
			smf2.place(x=140*5+12*3+5*4+3*5,y=30)
			Label(smf2,text=str(rawdata[0][5]),fg='cyan4',bg='white',font='msserif 35').pack()
			smf2 = Frame(b_frame,height=120,width=145,bg='white')
			total_rooms = Label(smf2,text='Reserved ?',fg='white',bg='cyan4',width=100,height=2,font='msserif 15')
			total_rooms.pack(side='top')
			#print (rdata)
			smf2.pack_propagate(False)
			smf2.place(x=140*6+12*4+5*5+3*6,y=30)
			p = ''
			if(rawdata[0][6] =='Unreserved'):
				p = 'No'
			else:
				p = 'Yes'
	...
	def payments():
		...
		first_line_1 = Frame(b_frame,height=38, width=308, bg='cyan4')
		first_line_1.place(x=0, y=68)
		l1 = Label(first_line_1,text='Transact Date', bg='cyan4', fg='white', font=('Helvetica', 16))
		l1.pack()
		first_line_1.pack_propagate(False)
		...
		lbl1=Label(fl3,text='Amount Paid',bg='cyan4',fg='white',font='msserif 17')
		lbl1.pack()
		...
		def get_id(event=None):
			first_ln_1=Frame(b_frame,height=38,width=308,bg='cyan4')
			first_ln_1.place(x=0,y=68)
			l1=Label(first_ln_1,text='Transact Date',bg='cyan4',fg='white',font=('Helvetica', 16))
			l1.pack()
			first_ln_1.pack_propagate(False)
			...
			fr4.place(x=0+308,y=191)
			fr4.pack_propagate(False)
			l1=Label(first_ln_1,text='Transaction Date',bg='cyan4',fg='white',font='msserif 17')
			idd = p_id.get()
	...
	#cur.execute("create table if not exists paymentsf(id number  primary key,f_name varchar,l_name varchar,c_number varchar,email varchar , r_n number ,day varchar,month varchar,year varchar,time varchar , method varchar,totalamt varchar)")
		...
		ok = Button(hline,text='OK',font='msserif 10',bg='white', activebackground='steelblue',fg='cyan4', command=get_id)
		ok.place(x=530,y=5)
		p_id.bind('<Return>',get_id)
		def pr():
